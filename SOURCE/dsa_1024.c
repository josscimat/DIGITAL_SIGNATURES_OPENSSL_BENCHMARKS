/* gcc dsa_1024.c -o dsa_1024 -pthread -lcrypto -ldl -static-libgcc -O2 -I/home/joss/openssl/include/ -L/home/joss/openssl/lib/ */
...
int main()
{
    ...
    EVP_PKEY_CTX_set_dsa_paramgen_bits(ctx, sizek);
